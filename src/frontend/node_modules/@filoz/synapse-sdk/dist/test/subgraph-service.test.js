...
describe('SubgraphService', () => {
    ...
    describe('getApprovedProvidersForCommP', () => {
        ...
        it('should handle invalid CommP', async () => {
            ...
            try {
                const service = new SubgraphService({ endpoint: mockEndpoint });
                await service.getApprovedProvidersForCommP(asCommP('invalid'));
                assert.fail('should have thrown');
            }
            catch (err) {
                assert.match(err.message, /Invalid CommP/);
            }
            finally {
                global.fetch = originalFetch;
            }
        ...
        describe('queryRoots', () => {
            ...
            it('should query roots with size filter', async () => {
                ...
                try {
                    ...
                    assert.equal(roots[0].cid?.toString(), 'baga6ea4seaqk27m35u73llf3pw2pwt7ovskmdxpgrgegzupiwzhrxppzgxxmaei');
                }
                finally {
                    global.fetch = originalFetch;
                }
